...
/// Expected issuer for Embedding Tool auth tokens
const EXPECTED_ISSUER: &str = "https://auth.embed.example.com/";

/// Expected audience for Embedding Tool MCP tokens
const EXPECTED_AUDIENCE: &str = "https://embed.example.com/";

/// JWKS endpoint for Embedding Tool auth
const JWKS_ENDPOINT: &str = "https://auth.embed.example.com/.well-known/jwks.json";
...
/// Validate a JWE token header from Embedding Tool auth service
///
/// This function validates the JWE token header structure and issuer.
/// For Embedding Tool tokens using "dir" algorithm with A256GCM encryption.
...
mod tests {
    ...
    #[tokio::test]
    async fn test_validate_embedtool_jwe_token() {
        // Example JWE token from Embedding Tool auth service
    ...
    async fn test_jwks_fetching() {
        ...
        // Test fetching JWKS from Embedding Tool auth endpoint
